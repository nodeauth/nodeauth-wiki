---
description: "NodeAuth 数据手动导出指南。为您提供高度安全、完全本地化的数据导出方案，支持 NodeAuth 加密 JSON、2FAS、Aegis 等多种第三方兼容格式。特别推介“HTML 离线交互页”功能，助您在极端断网或服务器不可达的情况下，无需联网即可通过单文件离线查看所有动态码，确保数据主权与访问连续性。"
---
# 数据手动导出
...
> [!TIP]
> **应急恢复包**：如果您导出了 JSON 文件但暂时无法访问 NodeAuth，可以使用项目内置的 [离线解密脚本](../recovery/index.md) 进行脱机提取。
